					...
					<div class="row">
						...
						<?php if( have_posts() ) : ?>
							...
							<?php while( have_posts() ) : the_post(); ?>					
								...
								<?php $portdesc  = get_post_meta( get_the_ID(),'_stech_portdesc', true ); 
								$pgellaryu  = get_post_meta( get_the_ID(),'_stech_pgellaryu', true ); 
								...
								<div class="col-md-6">
									<div class="pimgs">
										<div class="single_gallery owl-carousel  curosel-style">										
											<?php
												stech_slider_o('_stech_pgellaryu','full');									
											?>																				
										</div>			
									</div>
								</div>
